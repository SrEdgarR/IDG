...
**Este proyecto no incluye un instalador ni una extensión lista para usar.** Incluye una aplicación de desarrollo que ya gestiona descargas HTTP/HTTPS desde la ventana. El [recorrido para desarrolladores](APP_DEVELOPMENT.md) permite probar archivos locales controlados. Esta guía se actualizará al existir artefactos verificados.
