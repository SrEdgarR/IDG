...
| UI-01 a UI-08 | 02, 05, 14, 15 | EN_CURSO; revisión visual `workspace-ui` VERIFICADA en galería local | App, DownloadList, Dialogs, Settings, galería, `workspace.css`, tokens y popup; `test-ui.mjs` cubre tamaños/temas/diálogos. Backend conectado y probado en 05/06; revisión física WebView2, accesibilidad exhaustiva y rendimiento final pendientes. |
