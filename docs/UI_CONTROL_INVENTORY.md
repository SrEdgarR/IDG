...
| CTL-055 | Extensión | Estado/badge/icono | Reflejar conexión y trabajos reales | Runtime events | Handshake real | Sin timer ficticio ni datos stale como actuales | 01,07,08 | EN_CURSO: conexión/reconexión real, eventos y archivo IDG básico verificados en Chromium aislado; badge en matriz ampliada pendiente |
| CTL-056 | Extensión | AutoPick global/por sitio | Cambiar modo efectivo | UpdateSettings | Permisos válidos | Reconexión y opción persistente | 07,08 | EN_CURSO: tres modos y persistencia tras reabrir popup verificados; sitio y diálogo de permiso interactivo pendientes |
...
| CTL-058 | Extensión | Usar navegador | Conservar vía funcional sin recaptura | ReleaseCapture | Captura no comprometida | POST/blob/no transferible con fallback | 07,08 | EN_CURSO: cancelación del diálogo, modo navegador y excepción `.bin` conservaron archivo y hash; caídas/duplicados pendientes |
| CTL-059 | Extensión | Menú contextual de enlace/medio | Solicitar captura del recurso pertinente | PrepareCapture | Enlace/medio compatible | No crear menú invasivo en todo elemento | 07,08 | EN_CURSO: enlace elegido en previsualización, trabajo y hash verificados con origen local autorizado; gesto real de icono/menú contextual pendiente |
