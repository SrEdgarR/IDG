...
| CTL-057 | Extensión | Controles de trabajos/Abrir IDG | Actuar sobre mismo trabajo del escritorio | Native commands | Host disponible | Error si app ausente; no éxito ficticio | 07,08 | EN_CURSO: comandos nativos limitados para trabajos no privados y apertura; pausa/reanudación desde popup pendiente |
