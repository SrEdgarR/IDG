...
| CTL-059 | Extensión | Menú contextual de enlace/medio | Solicitar captura del recurso pertinente | PrepareCapture | Enlace/medio compatible | No crear menú invasivo en todo elemento | 07,08 | EN_CURSO: menús solo enlace/vídeo después del permiso; gesto real e integración pendientes |
