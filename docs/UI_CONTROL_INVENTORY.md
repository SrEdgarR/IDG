...
| CTL-056 | Extensión | AutoPick global/por sitio | Cambiar modo efectivo | UpdateSettings | Permisos válidos | Reconexión y opción persistente | 07,08 | EN_CURSO: tres modos y persistencia tras reabrir popup verificados; exclusiones sitio/MIME/tamaño y revocación en unitarias; diálogo de permiso y gesto de sitio interactivos pendientes |
