...
| CTL-055 | Extensión | Estado/badge/icono | Reflejar conexión y trabajos reales | Runtime events | Handshake real | Sin timer ficticio ni datos stale como actuales | 01,07,08 | EN_CURSO: conexión/reconexión y corte del motor antes/después de aceptar verificados en Chromium aislado; badge en matriz ampliada pendiente |
| CTL-056 | Extensión | AutoPick global/por sitio | Cambiar modo efectivo | UpdateSettings | Permisos válidos | Reconexión y opción persistente | 07,08 | EN_CURSO: tres modos y persistencia tras reabrir popup verificados; exclusiones sitio/MIME/tamaño, revocación y borrador de exclusión ante respuesta tardía en unitarias; diálogo de permiso y gesto de sitio interactivos pendientes |
| CTL-057 | Extensión | Controles de trabajos/Abrir IDG | Actuar sobre mismo trabajo del escritorio | Native commands | Host disponible | Error si app ausente; no éxito ficticio | 07,08 | EN_CURSO: Pausar/Reanudar desde popup verificados con trabajo y motor reales; el botón permanece estable ante eventos de progreso; apertura/errores del control pendientes |
| CTL-058 | Extensión | Usar navegador | Conservar vía funcional sin recaptura | ReleaseCapture | Captura no comprometida | POST/blob/no transferible con fallback | 07,08 | EN_CURSO: cancelación, modo navegador, exclusión `exe` codificada y cortes del motor antes/después de aceptar conservaron original/hash; caída del proceso host pendiente |
| CTL-059 | Extensión | Menú contextual de enlace/medio | Solicitar captura del recurso pertinente | PrepareCapture | Enlace/medio compatible | No crear menú invasivo en todo elemento | 07,08 | EN_CURSO: dos clics en enlace/oferta se limitan a un envío por botón; enlace elegido produjo un trabajo real; gesto de icono/menú contextual pendiente |
