...
| CTL-055 | Extensión | Estado/badge/icono | Reflejar conexión y trabajos reales | Runtime events | Handshake real | Sin timer ficticio ni datos stale como actuales | 01,07,08 | EN_CURSO: conexión/reconexión y caída del motor antes de aceptar verificadas en Chromium aislado; badge en matriz ampliada pendiente |
...
| CTL-058 | Extensión | Usar navegador | Conservar vía funcional sin recaptura | ReleaseCapture | Captura no comprometida | POST/blob/no transferible con fallback | 07,08 | EN_CURSO: cancelación, modo navegador, exclusión `exe` codificada y caída antes de aceptar conservaron original/hash; pérdida tras aceptación pendiente |
| CTL-059 | Extensión | Menú contextual de enlace/medio | Solicitar captura del recurso pertinente | PrepareCapture | Enlace/medio compatible | No crear menú invasivo en todo elemento | 07,08 | EN_CURSO: doble clic en enlace elegido produjo una propuesta/trabajo real; gesto real de icono/menú contextual pendiente |
