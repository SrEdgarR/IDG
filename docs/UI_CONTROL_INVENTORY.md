...
| CTL-050 | `Clipboard.tsx`, monitor del runtime y adaptador Windows; apagado por defecto, activar/desactivar, revisar/descartar | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |

Estas comprobaciones no certifican Windows 10, accesibilidad exhaustiva, DPI físico ni acciones físicas de energía. Las matrices de cierre inferiores conservan evidencia histórica de sus fases.

Contrato inicial ampliado. El estado funcional sigue separado del avance visual: consulta la matriz vigente de fase 06 y la evidencia histórica de fases 05 y 02 debajo; una superficie no acredita su backend. Los nombres de comandos son contratos orientativos que se deben ajustar al protocolo real, no API ya implementadas.
...
| CTL-002 | Principal | Sidebar: estados y categorías | Filtrar conservando foco | QueryDownloads | Vista disponible | Cada sección muestra sus resultados reales | 02,06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
| CTL-003 | Principal | Buscador global | Buscar por texto permitido | QueryDownloads | Sin exponer secretos | Nombre/dominio/ruta y vacío de resultados | 02,06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
| CTL-004 | Principal | Filtros y Limpiar | Aplicar/restablecer filtros | QueryDownloads | Filtros válidos | Fecha/tamaño/sitio/estado combinados | 02,06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
...
| CTL-006 | Principal | Seleccionar una/varias/todas | Cambiar selección sin ejecutar acciones | Estado UI | Filas seleccionables | Teclado y alcance de selección claros | 02,06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
| CTL-007 | Principal | Barra de acciones masivas | Operar solo trabajos compatibles | BatchCommand | Selección válida | Resumen parcial sin éxito falso | 02,06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
...
| CTL-015 | Fila | Menú: quitar del historial | Quitar registro sin borrar el archivo | RemoveHistory | Estado permite retirar registro | Archivo del disco permanece | 06,12 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
| CTL-016 | Fila | Menú: eliminar del disco | Eliminar solo con confirmación específica | DeleteDownloadedFile | Propiedad/ruta confirmadas | Archivo enumerado y cancelación segura | 06,12 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
| CTL-017 | Fila | Cambiar prioridad/cola/categoría | Actualizar trabajo real | UpdateDownload | Cambio permitido por estado | Persistencia tras reiniciar | 06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
...
| CTL-026 | Nueva descarga | Añadir a cola | Crear según política de la cola | EnqueueDownload | Cola válida | Horario/orden realmente respetados | 05,06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
...
| CTL-036 | Colas | Crear/editar/eliminar cola | Administrar cola y destino de trabajos | Queue CRUD | Sin pérdida de trabajos | Confirmación al afectar descargas | 06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
| CTL-037 | Colas | Iniciar/pausar/reordenar | Controlar secuencia real | QueueCommand | Trabajos compatibles | Orden y máximo simultáneo comprobados | 06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
| CTL-038 | Colas | Horario y acción al terminar | Programar y advertir apagado | UpdateSchedule | Runtime activo y opción válida | No prometer descarga con PC apagada | 06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
| CTL-039 | Reglas | Añadir/editar/activar/priorizar | Organizar por condiciones soportadas | Rule CRUD | Regla válida | Persistencia y conflictos explicados | 06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
| CTL-040 | Reglas | Previsualizar | Explicar resultado sin efectos | EvaluateRulePreview | Datos de ejemplo claros | No mover/borrar por previsualizar | 06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
| CTL-041 | Importar | Pegar varias/TXT/CSV/soltar enlace | Validar lista antes de crear | ParseImport / AddDownloads | Entradas admitidas | Errores por entrada; no ejecutar texto | 06 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
...
| CTL-045 | Ajustes | AutoPick/excepciones/formato/tamaño | Cambiar captura efectiva | UpdateSettings | Sincronización disponible o diferida clara | Sitios ignorados permanecen en navegador | 07,08 | EN_CURSO: modo global y excepción `.bin` verificados con archivo real; sitio/MIME/tamaño pendientes |
...
| CTL-049 | Ajustes | Historial/modo privado/estadísticas | Aplicar política real de retención | UpdatePrivacySettings | Consentimiento aplicable | Sin historial privado residual indebido | 06,12 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
| CTL-050 | Ajustes | Portapapeles/ventanas flotantes | Activar capacidades opcionales | UpdateSettings | Opt-in | Desactivar detiene monitorización | 06,12 | IMPLEMENTADO; ver matriz 06 vigente, pruebas y límites de verificación |
...
| CTL-055 | Extensión | Estado/conexión/trabajos | Mostrar snapshot real, reconectar y reflejar actividad | Native Messaging | Host y runtime compatibles | Sin timer ficticio ni estado stale | 01,07,08 | Chromium: bridge/badge y popup con runtime verificados en fase 07. Firefox: código y pruebas de componente/manifiesto pasan; conexión real en fase 08 BLOQUEADA por registro de host en otro checkout. Badge Firefox y gesto normal pendientes. |
| CTL-056 | Extensión | AutoPick global/por sitio | Requisito de producto, activar captura futura | UpdateSettings / permisos mínimos | No se declara activo mientras no funcione | Preferencia no debe aparentar habilitar captura | 07,08 | AutoPick sigue siendo requisito; captura automática deshabilitada. El popup no ofrece un ajuste que la active. Permisos y gestos del manifiesto normal pendientes; no hay controles actuales de exclusión automática en el popup. |
| CTL-057 | Extensión | Trabajos / Abrir IDG / Reconectar | Actuar sobre el trabajo real o explicar desconexión | Native commands | Host disponible | Errores visibles, sin éxito ficticio | 07,08 | Chromium: acciones y bridge probados en fase 07. Firefox: lista de trabajos, Pausar/Reanudar, Abrir IDG y Reconectar tienen pruebas unitarias; handshake/transferencia real en esta fase pendiente por registro externo. |
| CTL-058 | Extensión | Usar navegador / fallback seguro | Conservar vía del navegador si no es reproducible | Capture handoff | Captura no segura o no comprometida | No cancelar el original antes de aceptación durable | 07,08 | Chromium: enlaces explícitos y recuperación real probados en fase 07; descargas observadas permanecen en Chromium. Firefox: enlace directo implementado, E2E/hash real BLOQUEADO. Sesiones autenticadas no soportadas; POST/blob/páginas de acceso conservan alternativa de navegador. |
| CTL-059 | Extensión | Previsualizar o menú contextual de enlace | Solicitar solo recursos elegidos explícitamente | PrepareCapture | URL directa compatible | No añadir menú en medios o elementos no compatibles | 07,08 | Chromium: previsualización de enlaces; Firefox: menú contextual limitado a enlaces, código y unit tests pasan. Gestos con menú/icono y permisos normales pendientes; no se captura video/medio. |
...
| CTL-055–059 | Conexión / Sí / Solo puente | Host mantiene permisos mínimos anteriores | Evidencia histórica de fase 05: Chromium/Firefox reales automatizados, sin captura ni gestión de descargas de extensión. La implementación posterior y los pendientes actuales están en la actualización fase 08 al final. |

## Estado actual de extensión — fase 08, 2026-09-26

Firefox tiene manifiesto MV3 propio con `background.scripts`, ID Gecko estable, permisos mínimos `nativeMessaging` y `menus`, y ventanas privadas deshabilitadas. `browser-api.ts` mantiene la diferencia de API en un adaptador pequeño. Los popups tienen conexión/reconexión, trabajos reales y comandos de pausa/reanudación; Firefox acepta una URL directa escrita o un enlace contextual seleccionado, y espera aceptación de IDG antes de iniciar.

**Automatizado y aprobado en esta fase:** 50 pruebas unitarias/componente, comprobación estática de manifiestos Firefox/Chromium, `pnpm check`, build separado y suite general `scripts/Check.ps1`. **No ejecutado/aprobado:** transferencia Firefox con Native Messaging y hash final. El arnés real se bloqueó porque el registro Firefox HKCU apunta a un host de otro checkout; no se cambió el registro ni se repitió el intento. **Pendiente con manifiesto normal:** pedir/conceder/rechazar permisos y abrir mediante icono/`activeTab`/menú contextual. Las pruebas con permisos preconcedidos no sustituyen ese recorrido.

AutoPick continúa siendo requisito del producto; la captura automática de descargas ya iniciadas está deshabilitada y las descargas siguen en el navegador. Las sesiones autenticadas no se transfieren. La limitación de `DownloadItem` se refiere a que esa API no expone método HTTP ni cuerpo original; no demuestra que cualquier vía futura compatible sea imposible. Véase la matriz por navegador y el [estado de fase 08](IMPLEMENTATION_STATUS.md) para la atribución exacta por commit.
