...
Las variables solo afectan a esa terminal y sus procesos. Elige `$prueba06/files` en el asistente y omite el navegador. No publiques la ruta resultante. La fuente de portapapeles de fixture solo existe en builds de desarrollo; no lee tu portapapeles.
