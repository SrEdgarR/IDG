...
Esta etapa parte de `b6b4668189d595f9a7fd490653036c0c455769f6`: fase 07 integrada con el rediseño visual. Las fases de producto están **pausadas**. La rama `test/cobertura-y-regresiones` propone solo pruebas y correcciones locales de defectos demostrados por regresiones; depende de `feat/07-extension-chromium`, que aún no está en `main`. No atribuyas a `main` esta cobertura ni las funciones de fases 06/07.
